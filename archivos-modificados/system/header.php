...
echo "<link rel=stylesheet href=\"../Css-general.php\" type=\"text/css\">\n";
...
echo "<tr><td nowrap bgcolor=\"#fefefe\" align=center>";
echo "<img src=\"../images/smallballoontransp.png\" alt=\"\">";
echo "<font color=\"#000000\">BOCA</font>";
echo "</td><td bgcolor=\"#fefefe\" width=\"99%\">\n";
echo "Username: " . $_SESSION["usertable"]["userfullname"] ."<br>\n";
list($clockstr,$clocktype)=siteclock();
echo "</td><td bgcolor=\"#fefefe\" align=center nowrap>&nbsp;".$clockstr."&nbsp;</td></tr>\n";
echo "</table>\n";
...
echo "<ul id=\"menu\">\n";
echo "<a href=\"contest.php\"><li>Contest</li></a>\n";
echo "<a href=\"option.php\"><li>Options</li></a>\n";
echo "<a href=\"faq.php\"><li>Preguntas frecuentes</li></a>\n";

echo "<a href=\"../index.php\"><li>Logout</li></a>\n";
echo "</ul>\n";
echo "</div>\n";
echo "</nav>\n";
