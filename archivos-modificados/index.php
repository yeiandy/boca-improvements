  ...
  <tr align="center" valign="middle"> 
    <td> 
      <form name="form1" action="javascript:computeHASH()">
		...
		<p class="info">Sistema de administración para el registro de 
		competencias de programación</p>

		<p class="info"><span class="black">Principales objetivos:</span> fortalecer el trabajo en equipo,
		la capacidad de análisis, la honestidad, etc.</p>
